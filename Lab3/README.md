...
## Κριτική Εργαστηρίου
Το εργαστήριο δεν παρουσίασε κάποια ιδιαίτερη δυσκολία στην εκτέλεση του καθότι μας παρέχονταν πλήρεις και βοηθητικές οδηγίες μαζί με χρήσιμα εργαλεία που αυτοματοποιούσαν μέρος της διαδικασίας. Είχε ωστόσο αρκετή δουλειά, την οποία καταφέραμε να αυτοματοποιήσουμε σε έναν βαθμό με scripts, λόγω του όγκου της πληροφορίας που είχαμε και από το προηγούμενο εργαστήριο. Στη θεματολογία του το εργαστήριο μας εξοικίωσε με εργαλεία όπως το McPAT που δείχνουν και μια άλλη πτυχή του κόστους πέραν από αυτή του χώρου σε πυρίτιο που κληθήκαμε να δούμε στο προηγούμενο εργαστήριο. Επίσης ήρθαμε σε επαφή και με ζητήματα αποδοτικότητας και σύγκρισης επεξεργαστών με βάση το πρόβλημα που έχουμε να λύσουμε σαν σχεδιαστές.
