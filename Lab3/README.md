...
To delay αντιστοιχεί στον χρόνο εκτέλεσης κάθε προγράμματος και βρίσκεται στα
στατιστικά που παράγει το gem5. Το area και το energy υπολογίζονται με την
βοήθεια του McPAT. Συγκεκριμένα, η ενέργεια αντιστοιχεί στο γινόμενο του χρόνου
εκτέλεσης επί το άθροισμα των Runtime Dynamic (Power), Subthreshold Leakage και
Gate Leakage.
...
---------|---|---|----|----
bzip|116.89|170.47|660.33|2359.5
mcf|55.53|101.15|422.43|1431.07
...
---------|---------|----------|---------|----------|---------|----------
bzip|142.95|143.39|170.47|176.37|230.72|228.88
mcf|83|83.37|101.15|92.75|123.12|122.23
...
---------|----------|----------|----------|----------|-----------|-----------
bzip|86.31|111.97|170.47|125.67|238.33|218.49
mcf|51.05|67.08|101.15|76.72|146.4|135.06
...
---------|----------|----------|----------|----------|----------|----------|-----------
bzip|167.59|184.2|170.47||246.67|199.16|320.9
mcf|115.67|114.25|101.15|89.13|117.77|95.22|153.02
hmmer|86.98|95.35|96.43|96.43|126.88|102.92|164.46
sjeng|5463.75|6045.9|5512.7||8297.91|6574.83|10912.69
...
Οι βέλτιστες τιμές των παραμέτρων της κρυφής μνήμης οι οποίες ελαχιστοποιούν το
γινόμενο energy-delay-area είναι οι παρακάτω:
...
L2 Cache  |1MB 8-way
D-Cache   |32KB 2-way
I-Cache   |16KB (bzip, hmmer, sjeng, libm) ή 32KB 2-way (mcf)

Το mcf εμφανίζει μεγαλύτερη απόδοση με την χρήση μεγαλύτερης I-Cache, διότι
περιέχει βρόγχους μεγάλου μεγέθους.
...
Παρ' όλες αυτες τις διαφορές, οι παράμετροι που επιλέξαμε σύμφωνα με την
συνάρτηση κόστους μας, με εξαίρεση το block size, συμπίπτουν με αυτές που
επιλέξαμε σύμφωνα με το McPAT.

## Κριτική Εργαστηρίου

Το εργαστήριο δεν παρουσίασε κάποια ιδιαίτερη δυσκολία στην εκτέλεση του καθότι
μας παρέχονταν πλήρεις και βοηθητικές οδηγίες μαζί με χρήσιμα εργαλεία που
αυτοματοποιούσαν μέρος της διαδικασίας. Είχε ωστόσο αρκετή δουλειά, την οποία
καταφέραμε να αυτοματοποιήσουμε σε έναν βαθμό με scripts, λόγω του όγκου της
πληροφορίας που είχαμε και από το προηγούμενο εργαστήριο. Στη θεματολογία του το
εργαστήριο μας εξοικίωσε με εργαλεία όπως το McPAT που δείχνουν και μια άλλη
πτυχή του κόστους πέραν από αυτή του χώρου σε πυρίτιο που κληθήκαμε να δούμε στο
προηγούμενο εργαστήριο. Επίσης ήρθαμε σε επαφή και με ζητήματα αποδοτικότητας
και σύγκρισης επεξεργαστών με βάση το πρόβλημα που έχουμε να λύσουμε σαν
σχεδιαστές.
